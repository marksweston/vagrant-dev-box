...
# backwards compatibility). Please don't change it unle§ you know what
# you're doing.
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, path: "provision/install-databases.sh"
  config.vm.provision :shell, path: "provision/install-rvm.sh", args: "head", privileged: false
